...
export function MatchupHeader({ game, awayTeamStats, homeTeamStats }: MatchupHeaderProps) {
  // Use team names from stats (ESPN for CBB) when available, otherwise Odds API names
        ...
        <CardBody className="p-6">
          <div className="flex justify-between items-center">
            ...
            <div className="text-center flex-1 flex flex-col items-center gap-4">
              <TeamLogo teamName={awayTeamName} size={80} logo={awayTeamStats?.logo} />
              <div>
            ...
            {/* Home Team */}
            <div className="text-center flex-1 flex flex-col items-center gap-4">
              <TeamLogo teamName={homeTeamName} size={80} logo={homeTeamStats?.logo} />
              <div>
                <h2 className="text-xl font-semibold mb-1 text-text-dark">
                  {homeTeamName}
                </h2>
